import { Users, TrendingUp, Search, UserPlus, CheckCircle } from 'lucide-react';
...
interface GroupsDiscoveryProps {
  navigateTo: (screen: Screen) => void;
}

export function GroupsDiscovery({ navigateTo }: GroupsDiscoveryProps) {
  const myGroups = [
    {
      id: 1,
  ...
  const suggestedGroups = [
    {
      ...
      members: 15234,
      posts: 2341,
      description: 'Advanced TypeScript patterns, best practices, and discussions',
    ...
    },
    {
      ...
      members: 21453,
      posts: 3456,
      description: 'Daily algorithm challenges and interview preparation',
      image: 'https://images.unsplash.com/photo-1675495277087-10598bf7bcd1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb2RlJTIwYWxnb3JpdGhtJTIwdGVjaG5vbG9neXxlbnwxfHx8fDE3NjI3NTU3NjZ8MA&ixlib=rb-4.1.0&q=80&w=1080',
    ...
    },
    {
      ...
      members: 18765,
      posts: 2890,
      description: 'ML, data analysis, and scientific computing with Python',
      image: 'https://images.unsplash.com/photo-1587037325379-0b8807b41f23?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxvbmxpbmUlMjBsZWFybmluZyUyMGNsYXNzcm9vbXxlbnwxfHx8fDE3NjI3NTU3NjZ8MA&ixlib=rb-4.1.0&q=80&w=1080',
    ...
    },
    {
      ...
      members: 16234,
      posts: 2134,
      description: 'iOS, Android, React Native, and Flutter discussions',
      image: 'https://images.unsplash.com/photo-1566915896913-549d796d2166?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9ncmFtbWluZyUyMHdvcmtzcGFjZSUyMGRldmVsb3BlcnxlbnwxfHx8fDE3NjI3Mzg0MzV8MA&ixlib=rb-4.1.0&q=80&w=1080',
      category: 'Mobile',
      trending: false
    }
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Connect with learners and professionals who share your interests</p>
      </div>
      ...
      {myGroups.length > 0 && (
        <div className="mb-8">
          <h2 className="text-gray-900 mb-4">My Groups</h2>
          <div className="grid grid-cols-2 gap-6">
            {myGroups.map((group) => (
              <Card 
                key={group.id} 
                className="overflow-hidden hover:shadow-lg transition-shadow cursor-pointer"
                onClick={() => navigateTo('group-feed')}
              >
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <h3 className="text-gray-900 mb-2">{group.name}</h3>
      ...
      {/* Suggested Groups */}
      <div>
        <h2 className="text-gray-900 mb-4">Suggested for You</h2>
          ...
          {suggestedGroups.map((group) => (
            <Card key={group.id} className="overflow-hidden hover:shadow-lg transition-shadow">
              <div className="h-40 overflow-hidden relative">
                ...
                />
                {group.trending && (
                  <Badge className="absolute top-3 right-3 bg-[#00BCD4] gap-1">
                  ...
                  <div className="flex -space-x-2">
                    {[1, 2, 3].map((i) => (
                      <Avatar key={i} className="border-2 border-white w-8 h-8">
                        <AvatarFallback className="bg-[#1A237E] text-white text-xs">
                          U{i}
                        </AvatarFallback>
                      </Avatar>
                    ))}
                  </div>
                  <span className="text-gray-500 text-sm">+{(group.members - 3).toLocaleString()} members</span>
                </div>
                <Button 
                  className="w-full mt-4 bg-[#00BCD4] hover:bg-[#00ACC1] text-white gap-2"
                >
