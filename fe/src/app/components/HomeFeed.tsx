...
export function HomeFeed({ navigateTo }: HomeFeedProps) {
  const posts = [
    {
      id: 1,
      author: 'Sarah Chen',
          ...
          <Card className="p-4">
            <div className="flex items-center gap-3">
              ...
              <input
                ...
                className="flex-1 px-4 py-2 bg-gray-50 dark:bg-gray-700 rounded-full border border-gray-200 dark:border-gray-600 focus:outline-none focus:border-[#00BCD4] text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400"
              />
            </div>
          </Card>
              ...
              <div className="p-6">
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="text-gray-900 dark:text-white cursor-pointer hover:text-[#1A237E] dark:hover:text-[#00BCD4]" onClick={() => navigateTo('user-profile')}>
                        {post.author}
                      </h4>
